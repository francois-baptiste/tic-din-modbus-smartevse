...
void handleStatusNetwork(AsyncWebServerRequest *request)
{
  ...
  // New Extensions Mapping
  sdm630F("342-343 Total Aggregated Active Energy :", 342, "kWh");
  ...
  response->printf("<tr><td><strong>600 Is_tempo_blue :</strong></td><td>%u</td></tr>", sdm630InputRegisters[600]);
  response->printf("<tr><td><strong>601 Is_tempo_white :</strong></td><td>%u</td></tr>", sdm630InputRegisters[601]);
  response->printf("<tr><td><strong>602 Is_tempo_red :</strong></td><td>%u</td></tr>", sdm630InputRegisters[602]);
  response->printf("<tr><td><strong>603 Is_hp :</strong></td><td>%u</td></tr>", sdm630InputRegisters[603]);
  response->printf("<tr><td><strong>604 Is_hc :</strong></td><td>%u</td></tr>", sdm630InputRegisters[604]);
  response->printf("<tr><td><strong>605 Is_base_tariff :</strong></td><td>%u</td></tr>", sdm630InputRegisters[605]);
  response->printf("<tr><td><strong>606 Is_hphc_tariff :</strong></td><td>%u</td></tr>", sdm630InputRegisters[606]);
  response->printf("<tr><td><strong>607 Is_tempo_tariff :</strong></td><td>%u</td></tr>", sdm630InputRegisters[607]);
  response->printf("<tr><td><strong>608 Is_Power_Overflow :</strong></td><td>%u</td></tr>", sdm630InputRegisters[608]);

  sdm630F("609-610 Contracted power :", 609, "kVA");
  sdm630F("612-613 ESP Temperature :", 612, "°C");
  sdm630F("614-615 Active pwr (10s SMA) :", 614, "W");
  sdm630F("616-617 Apparent pwr (10s SMA) :", 616, "VA");
  sdm630F("618-619 Current L1 (10s SMA) :", 618, "A");
  sdm630F("620-621 Voltage L1 (10s SMA) :", 620, "V");
